export default [
	...
	},
	{
...

	  {
		...
		routes: [
		  {
			path: '/quan-ly-clb/quan-ly-don-dang-ky',
			name: 'QuanLyDonDangKy',
			component: './QuanLyClb/DonDangKy/DonDangKy',
			icon: 'ScheduleOutlined',
		  },
		  {
			path: '/quan-ly-clb/ung-vien',
			name: 'UngVien',
			component: './QuanLyClb/UngVien/UngVien',
			icon: 'ScheduleOutlined',
		  },
		  {
			path: '/quan-ly-clb/thanh-vien',
			name: 'ThanhVien',
			component: './QuanLyClb/ThanhVien/ThanhVien',
			icon: 'ScheduleOutlined',
		  },
		  {
			path: '/quan-ly-clb/bao-cao',
			name: 'BaoCao',
			component: './QuanLyClb/BaoCao/BaoCao',
			icon: 'ScheduleOutlined',
		  },
		],
	  },
